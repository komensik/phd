...
here::here()
raw_data_cleaned <- readr::read_csv("data/cleaned/coded_data__08_2026_2.csv")
...
help_means_incarc <- (raw_data_cleaned %>%
  ...
  dplyr::summarise(
    q23_2_rev = mean(q23_2_rev, na.rm = TRUE),
    q23_7_rev = mean(q23_7_rev, na.rm = TRUE),
    q25_2_rev = mean(q25_2_rev, na.rm=TRUE),
    q25_3_rev = mean(q25_3_rev, na.rm=TRUE),
    q25_4_rev = mean(q25_4_rev, na.rm=TRUE),
    q25_6_rev = mean(q25_6_rev, na.rm=TRUE),
...
policy_vars <- c(
  "q23_2_rev", "q23_7_rev", "q25_2_rev",
  "q25_3_rev", "q25_4_rev", "q25_6_rev", "prisonhelp"
)
...
This section continues to use variable_labels.R. The goal of this section was to avoid
and clean up extensive seperated regressions, and instead incorporate use loop that iteratively work through outcome variables and incorporate controls.
...
Run each through:
    ...
    Model 3: demographics + party/ideology
    Model 4: full attitudes
...
control_waves <- list(
  ...
  full_attitudes = c(demo_controls, party_ideo_controls,
                     fire_controls) # 8-26 once desorcore fixed, add #desor_core to this list in full_attitudes
)
```
