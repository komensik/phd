...
#### a. Label Deserving & Power Blocks – redefine block using column names. Used the below to create block assignments for participants in A, B, and C (to ultimately consolidate)
