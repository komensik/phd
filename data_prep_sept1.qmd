...
#original_data <-read_csv("./data/raw/scotg_results.csv")
...
Assign Deserving & Power Blocks – redefine block using column names. Used the below to create block assignments for participants in A, B, and C (to ultimately consolidate).
...
accepted_variants <- c("purple", "\"purple\"", "purpke", "purplee", "prurprle", "purpl", "purp", "💜", "🟣")
...
```{r}
names(raw_data)
summary(raw_data$duration_in_seconds)

plot(raw_data_cleaned$duration_in_seconds)
...
#new section to try to make data not just variables show up
...
d_crim_abc d_incppl_pris_abc d_incwomen_abc q15_1 q15_2 q15_3 q15_4 q15_5 q15 q25_1 q25_2 q25_3 q25_4 q25_1 q4_1_1 q4_1_2 q4_1_3 q4_2_1 q4_2_2 q4_2_3
