...
here::here()
#raw_data_cleaned <- readr::read_csv("data/cleaned/...")
#raw_data_cleaned <- readr::read_csv("data/cleaned/sept_14.csv") 
raw_data_cleaned <- readr::read_csv("data/cleaned_control_data.csv")
...
mh1_no_cont <- lm(min_wage ~ impact, data = raw_data_cleaned)
mh2_no_cont <- lm(free_calls ~ impact, data = raw_data_cleaned)
mh3_no_cont <- lm(ed_funds ~ impact, data = raw_data_cleaned)
mh4_no_cont <- lm(alt_sentencing ~ impact, data = raw_data_cleaned)
...
sum(complete.cases(raw_data_cleaned[, c("impact", "d_incppl_pris_abc", "prisonhelp", "prisonpen","Republican","Democrat","fiscal_ideology","social_ideology","penalpoint","desor_core","fire_rare", "fire_privilege","fire_angry","fire_fear","gender","Black","Hispanic/Latino","OtherRace")]))
