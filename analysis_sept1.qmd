...
```{r}
#summary(sample$q15_1_1_to_5)
#summary(sample[police_items_1_to_5])
#sapply(sample[police_items_1_to_5], function(x) table(x, useNA = "ifany"))
...
desor_model <- lm(desor_core ~ dep_variable + Black+Hispanic+OtherRace+fiscal_ideology+social_ideology, data = sample)
summary(desor_model)
...
#impact - help 
test_impact_full <- lm(prisonhelp ~ impact + Black + Hispanic + OtherRace + gender + Republican + Democrat + fiscal_ideology + social_ideology +desor_core + fire_rare + fire_privilege + fire_angry + fire_fear, data = sample)

test_incarc_full <- lm(prisonhelp ~ incarc + Black + Hispanic + OtherRace + gender + Republican + Democrat + fiscal_ideology + social_ideology +desor_core + fire_rare + fire_privilege + fire_angry + fire_fear, data = sample)

#knowincarc 
test_knowincarc_full <- lm(prisonhelp ~ knowincarc + Black + Hispanic + OtherRace + gender + Republican + Democrat + fiscal_ideology + social_ideology +desor_core + fire_rare + fire_privilege + fire_angry + fire_fear, data = sample)

test_vict_full <- lm(prisonhelp ~ vict + Black + Hispanic + OtherRace + gender +  Republican + Democrat + fiscal_ideology + social_ideology +desor_core + fire_rare + fire_privilege + fire_angry + fire_fear, data = sample)
...
#impact - pun 
test_impact_full_pen <- lm(prisonpen ~ impact + Black + Hispanic + OtherRace + gender + Republican + Democrat + fiscal_ideology + social_ideology +desor_core + fire_rare + fire_privilege + fire_angry + fire_fear, data = sample)

test_incarc_full_pen <- lm(prisonpen ~ incarc + Black + Hispanic + OtherRace + gender + Republican + Democrat + fiscal_ideology + social_ideology +desor_core + fire_rare + fire_privilege + fire_angry + fire_fear, data = sample)

#knowincarc 
test_knowincarc_full_pen <- lm(prisonpen ~ knowincarc + Black + Hispanic + OtherRace + gender + Republican + Democrat + fiscal_ideology + social_ideology +desor_core + fire_rare + fire_privilege + fire_angry + fire_fear, data = sample)

test_vict_full_pen <- lm(prisonpen ~ vict + Black + Hispanic + OtherRace + gender +  Republican + Democrat + fiscal_ideology + social_ideology +desor_core + fire_rare + fire_privilege + fire_angry + fire_fear, data = sample)
...
m_des_inc_impact <- lm(d_incppl_pris_abc ~ impact + Black + Hispanic + OtherRace + gender + Republican + Democrat + fiscal_ideology + social_ideology + desor_core, data = sample)

m_des_inc_incarc <- lm(d_incppl_pris_abc ~ incarc + Black + Hispanic + OtherRace + gender + Republican + Democrat + fiscal_ideology + social_ideology + desor_core, data = sample)

m_des_inc_knowincarc <- lm(d_incppl_pris_abc ~ knowincarc + Black + Hispanic + OtherRace + gender + Republican + Democrat + fiscal_ideology + social_ideology + desor_core, data = sample)

m_des_inc_vict <- lm(d_incppl_pris_abc ~ vict + Black + Hispanic + OtherRace + gender + Republican + Democrat + fiscal_ideology + social_ideology + desor_core, data = sample)

##

m_des_crim_impact <- lm(d_crim_abc ~ impact + Black + Hispanic + OtherRace + gender + Republican + Democrat + fiscal_ideology + social_ideology + desor_core, data = sample)

m_des_crim_incarc <- lm(d_crim_abc ~ incarc + Black + Hispanic + OtherRace + gender + Republican + Democrat + fiscal_ideology + social_ideology + desor_core, data = sample)

m_des_crim_knowincarc <- lm(d_crim_abc ~ knowincarc + Black + Hispanic + OtherRace + gender + Republican + Democrat + fiscal_ideology + social_ideology + desor_core, data = sample)

m_des_crim_vict <- lm(d_crim_abc ~ vict + Black + Hispanic + OtherRace + gender + Republican + Democrat + fiscal_ideology + social_ideology + desor_core, data = sample)

##

m_des_incwomen_imp <- lm(d_incwomen_abc ~ impact + Black + Hispanic + OtherRace + gender + Republican + Democrat + fiscal_ideology + social_ideology + desor_core, data = sample)

m_des_incwomen_incarc <- lm(d_incwomen_abc ~ incarc + Black + Hispanic + OtherRace + gender + Republican + Democrat + fiscal_ideology + social_ideology + desor_core, data = sample)

m_des_incwomen_knowinc <- lm(d_incwomen_abc ~ knowincarc + Black + Hispanic + OtherRace + gender + Republican + Democrat + fiscal_ideology + social_ideology + desor_core, data = sample)

m_des_incwomen_vict <- lm(d_incwomen_abc ~ vict + Black + Hispanic + OtherRace + gender + Republican + Democrat + fiscal_ideology + social_ideology + desor_core, data = sample)
...
m4_inc <- lm(prisonpen ~ incarc + d_incppl_pris_abc +
    Republican + Democrat + fiscal_ideology + social_ideology +penalpoint + desor_core + fire_rare + fire_privilege + fire_angry + fire_fear + gender + Black + Hispanic + OtherRace,data = sample)
