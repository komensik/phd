...
{[}add something about interpretive effects{]} {[}\emph{While policy
feedback research has established that carceral contact influences
political participation and institutional trust, much less is known
about how such contact affects attitudes toward the targets of these
policies---specifically, how direct or proximal experience with
incarceration or victimization might reshape perceptions of incarcerated
people's deservingness and, in turn, opinions on prison policy.{]}} I
briefly review these literatures here.

In the wake of Schneider and Ingram's (1993) theory of social
constructions, a deservingness literature has coalesced around the idea
that attitudes towards policy targets are in dialectic with policy. That
is, policy design not only has ``interpretive effects'' on its targets
but also shapes discourse \emph{about} them. In this way, policy can
``telegraph to the public how target groups should be treated,'' and
helps to produce social constructions or ``value-laden components,
including stereotypes, dominant ideologies, and assumptions'' about
groups (Smith and Kreitzer 2024, PAGE). As consequence, social
constructions are contingent -- for example, on local, state, and
political and cultural contexts, and also on the political identity of
and ideology held by the `perceiver' (Smith and Kreitzer 2018). This
means both that policy can \emph{reflect} existing social constructions,
and that it can feed back to causally affect further social
constructions of who targets are. The notion of who targets \emph{are}
in turn affects how people perceive what they \emph{should} receive --
i.e., what they deserve.
...
constructions along five dimensions in an evolutionarily-grounded
impulse to help ``reciprocators'' and avoid ``free-riders'' (Petersen
2012, Aaroe and Petersen 2014). These ``CARIN'' criteria primarily
attend to cues about whether recipients cannot help their circumstances,
or whether they are seeking unearned benefits. They refer to:
...
How might experiences with policy shape how these characteristics or
social constructions are interpreted? In the context of student debt
relief, SoRelle and Laws (2023) find that people who have had student
debt themselves view borrowers as more deserving of debt forgiveness.
Maltby and Kreitzer (2022) finding that solidaristic effects of policy
experience begin to erode when one considers the deservingness of, in
this case, welfare recipients who benefit from a \emph{different}
welfare program than one's own. While SoRelle and Laws find empirical
support for these warmer perceptions hinging on the identity CARIN
characteristic, the deservingness literature otherwise offers scant
theoretical or empirical explanations for how and why not only direct,
but also proximate policy experiences might shape perceptions of target
deservingness. SoRelle and Laws' finding that {[}{]} also highlights an
additional gap in this literature, to empirically test whether
deservingness is a true mediator.

How might policy experience shape social constructions, perceptions of
target deservingness, and produce policy preferences?

While little work in the deservingness literature has taken this up up
directly, there are reasons to think it might. Within the deservingness
literature, the identity characteristic helps explain SoRelle and Laws'
(2023) finding that people who have had student debt themselves view
borrowers as more deserving of debt forgiveness. Similarly, Maltby and
Kreitzer's (2022) findings that solidaristic effects of policy
experience begin to erode when one considers the deservingness of, in
this case, welfare recipients who benefit from a \emph{different}
welfare program than one's own. {[}transition/clearly state further
deservingness limitations{]}

Alternatively, social construction scholars note that \textbf{particular
constructions are more sticky}.

What deservingness literature doesn't tell us (particularly about
proximal contact

\subsubsection{Policy Feedback}\label{policy-feedback}

Once enacted, policies can reshape politics and subsequent policy
outcomes.

Insights from policy feedback literature inform these gaps by showing
that both direct and indirect policy experience shapes policy
preferences,

\begin{itemize}
\item
  bridge -- forming preferences from policy experiences

  \begin{itemize}
  \tightlist
  \item
    ppl interpret that differentially based on experience
  \end{itemize}
\end{itemize}

{[}policy feedback literature tells us that people's experiences
shape{]}

{[}

. Findings from Soss's (2005) a study of recipients of means tested
versus non-means tested welfare, supports the latter.
