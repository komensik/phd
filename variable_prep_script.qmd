...
# ------------------------------------------------------------
# 5. Standardized version for models
# ------------------------------------------------------------
...
# step 3: save just the means of q25 help questions as prisonhelp

raw_data_cleaned <- raw_data_cleaned %>% 
  rowwise() %>% #dplyr should treat each row as own group so c_across() can return row level vector of cols for that row
  mutate(prisonhelp = mean(c_across(c(q25_2_rev, q25_3_rev, q25_4_rev, q25_6_rev)), na.rm = TRUE)) %>%
  ungroup()
...
prisonhelp is the average of means of the help items (just prison policy "help" excluding the prison and voting ones); q25_help_items is to look at them separately
...
#### D.4_B Q35 'Help-Oriented' Prison/Election Items
...
post_felony_vote_rev jail_access_rev_1_to_4 q25_help_data or q25_2_rev, q25_3_rev, q25_4_rev, q25_6_rev
