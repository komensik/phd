...
White: 0 1 <NA> 422 1181 619

```{r}
table(raw_data_cleaned$q51_2, useNA = "ifany")
```

Black or African American (2) 0 1 <NA> 1336 267 619
...
▢ Asian / Asian American (4) 0 1 <NA> 1525 78 619

```{r}
table(raw_data_cleaned$q51_5, useNA = "ifany")
```

▢ Native Hawaiian / Other Pacific Islander (5) 0 1 <NA> 1598 5 619

```{r}
table(raw_data_cleaned$q51_6, useNA = "ifany")
```

▢ Middle Eastern/ North African (6) 0 1 <NA> 1597 6 619

```{r}
table(raw_data_cleaned$q51_7, useNA = "ifany")
```

▢ Hispanic/Latino/a/e (7) 0 1 <NA> 1366 237 619

```{r}
table(raw_data_cleaned$q51_8, useNA = "ifany")
```

▢ My preferred response not listed (8) 0 1 <NA> 1583 20 619
